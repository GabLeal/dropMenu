...
class CustomDropdown<T> extends StatefulWidget {
  ...
  //Controlador que contem os itens que podem ser selecionados
  final DropController<T> controller;

  //Item que deve aparecer quando alguma opção for selecionada
      ...
      child: Container(
        ...
        child: OutlinedButton(
          style: OutlinedButton.styleFrom(
            ...
            backgroundColor:
                _currentIndex != -1 ? Colors.blue : style.backgroundColor,
            ...
            child: Row(
              ...
              children: [
                if (_currentIndex == -1) ...[
                  ...
                  Text(
                    // widget.item[_currentIndex],
                    widget.controller.itemTextSelected,
                    style: TextStyle(color: Colors.white),
                  )
                  // widget.itemEscolhido
                ],
                if (widget2.hideIcon != null)
                  RotationTransition(
                          ...
                          children: widget.controller.items
                            ...
                            return InkWell(
                              onTap: () {
                                ...
                                widget.onChange!(item.value!, item.key);
                                _toggleDropdown();
                              },
                              child: widget.items[item.key],
                              // child: item.value,
